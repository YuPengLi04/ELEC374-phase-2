...
add wave -noupdate /Load_tb_Case_3_4/Present_state
add wave -noupdate /Load_tb_Case_3_4/R0out
...
add wave -noupdate -radix hexadecimal /Load_tb_Case_3_4/DUT/R4/q
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {223802 ps} 0}
...
update
WaveRestoreZoom {0 ps} {160256 ps}
